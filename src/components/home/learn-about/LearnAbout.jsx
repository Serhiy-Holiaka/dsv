...
const LearnAbout = () => {
    return (
        <section className="py-16">
            <h5 className="font-bold text-[42px] leading-[130%] text-black-dark text-center">
                Learn about transport and logistics
            </h5>
            <div className="container max-w-mid grid grid-cols-4 gap-8 mt-16 mb-12">
                <div className="min-h-[357px] border border-gray-light rounded-2xl overflow-hidden [&_img]:hover:scale-105 [&_svg]:hover:translate-x-[6px] hover:shadow-md transition">
                    <div className="relative h-[200px] overflow-hidden">
                        <img className="absolute w-full h-full object-cover transition-transform duration-300" width={268} src="/src/assets/images/about/about-img-1.webp" alt="card img" />
                    </div>
                ...
                <div className="min-h-[357px] border border-gray-light rounded-2xl overflow-hidden [&_img]:hover:scale-105 [&_svg]:hover:translate-x-[6px] hover:shadow-md transition">
                    <div className="relative h-[200px] overflow-hidden">
                        <img className="absolute w-full h-full object-cover transition-transform duration-300" width={268} src="/src/assets/images/about/about-img-2.webp" alt="card img" />
                    </div>
                    <div className="px-5 py-6">
                ...
                <div className="min-h-[357px] border border-gray-light rounded-2xl overflow-hidden [&_img]:hover:scale-105 [&_svg]:hover:translate-x-[6px] hover:shadow-md transition">
                    <div className="relative h-[200px] overflow-hidden">
                        <img className="absolute w-full h-full object-cover transition-transform duration-300" width={268} src="/src/assets/images/about/about-img-3.webp" alt="card img" />
                    </div>
                    <div className="px-5 py-6">
                ...
                <div className="min-h-[357px] border border-gray-light rounded-2xl overflow-hidden [&_img]:hover:scale-105 [&_svg]:hover:translate-x-[6px] hover:shadow-md transition">
                    <div className="relative h-[200px] overflow-hidden">
                        <img className="absolute w-full h-full object-cover transition-transform duration-300" width={268} src="/src/assets/images/about/about-img-4.webp" alt="card img" />
                    </div>
                    <div className="px-5 py-6">
            ...
            <Button additionalClasses="mx-auto">Explore our insights</Button>
        </section>
    );
};
